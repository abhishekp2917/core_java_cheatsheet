package com.excercise.javaSerialization.SerializationBasics.example1;

/* 
    writing state of an object into file (serialization)

    and then reading its state from that file (de-serialization)
*/
